...
namespace signatures {
	...
	const DWORD dwEntityList = 0x4DCEB7C;
	const DWORD dwForceAttack = 0x31FF054;
	const DWORD dwForceAttack2 = 0x31FF060;
	const DWORD dwForceBackward = 0x31FF0A8;
	const DWORD dwForceForward = 0x31FF09C;
	const DWORD dwForceJump = 0x52789F8;
	const DWORD dwForceLeft = 0x31FF0B4;
	const DWORD dwForceRight = 0x31FF0C0;
	const DWORD dwGameDir = 0x62A880;
	const DWORD dwGameRulesProxy = 0x52EBA5C;
	const DWORD dwGetAllClasses = 0xDDCF2C;
	const DWORD dwGlobalVars = 0x58BCC8;
	const DWORD dwGlowObjectManager = 0x5316E98;
	const DWORD dwInput = 0x5220150;
	const DWORD dwInterfaceLinkList = 0x966044;
	const DWORD dwLocalPlayer = 0xDB35EC;
	const DWORD dwMouseEnable = 0xDB92F8;
	const DWORD dwMouseEnablePtr = 0xDB92C8;
	const DWORD dwPlayerResource = 0x31FD3E0;
	const DWORD dwRadarBase = 0x52038F4;
	const DWORD dwSensitivity = 0xDB9194;
	const DWORD dwSensitivityPtr = 0xDB9168;
	const DWORD dwSetClanTag = 0x8A290;
	const DWORD dwViewMatrix = 0x4DC0494;
	const DWORD dwWeaponTable = 0x5220C18;
	const DWORD dwWeaponTableIndex = 0x326C;
	const DWORD dwYawPtr = 0xDB8F58;
	const DWORD dwZoomSensitivityRatioPtr = 0xDBEF60;
	const DWORD dwbSendPackets = 0xD93D2;
	const DWORD dwppDirect3DDevice9 = 0xA5050;
	const DWORD find_hud_element = 0x283D48A0;
	const DWORD force_update_spectator_glow = 0x3BA6CA;
	const DWORD interface_engine_cvar = 0x3E9EC;
	const DWORD is_c4_owner = 0x3C76A0;
	const DWORD m_bDormant = 0xED;
	const DWORD m_flSpawnTime = 0x103C0;
	const DWORD m_pStudioHdr = 0x2950;
	const DWORD m_pitchClassPtr = 0x5203B90;
	const DWORD m_yawClassPtr = 0xDB8F58;
	const DWORD model_ambient_min = 0x58F03C;
	const DWORD set_abs_angles = 0x1E51E0;
	const DWORD set_abs_origin = 0x1E5020;
} // namespace signatures