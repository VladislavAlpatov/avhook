...
void CSettingsWindow::DrawMisceleniusConfiguration(MiscSettings& miscSettings)
{
...
bool CSettingsWindow::IsPathEndWith(const char* path, const char* end)
{
...
void CSettingsWindow::DrawMenuAndCfgConfiguration(SAllSettings* pAllSettings)
{
